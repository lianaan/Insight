...
for si = 1:length(indi_sel)
    ...
    for modi = 1:Nmodels 
        ...
        if isfile(['fitsS_model_', num2str(modi), '_exp_',num2str(exp_i),'_sbji_', num2str(sbji), '.mat'])
            load(['fitsS_model_', num2str(modi), '_exp_',num2str(exp_i),'_sbji_', num2str(sbji), '.mat'])
...
%%
save ('nll_models_1_6_all.mat', 'nll_all', '-mat')
save(['params_all_models6_E2_Nsubj_', num2str(length(indi_sel)), '.mat'],'AIC_all', 'BIC_all','nll_sum_all','nll_all', 'nll_si_ci_all', 'params_fit_best_all','params_fit_si_ci_all', '-mat' )
%}
